...
library(data.table)
library(scales)
pull <- read_excel("C://Users//jamesa-anderson//OneDrive - John A. Logan College//Documents//fall.xlsx")
count <- read_excel("C://Users//jamesa-anderson//OneDrive - John A. Logan College//Documents//fall.xlsx", 
    sheet = "head")
...
```{r include=FALSE}
dual <- read_excel("~/dual enrollment fall.xlsx")
...
F1<-division.table %>% filter(Term == "F1")
F2<-division.table %>% filter(Term == "F2")
F4<-division.table %>% filter(Term == "F4")
F6<-division.table %>% filter(Term == "F6")
F7<-division.table %>% filter(Term == "F7")
...
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Adult Education for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Adult Education for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Adult Education for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Adult Education for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Adult Education for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Allied Health Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Allied Health for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Allied Health for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Allied Health for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Allied Health for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Allied Health for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Applied Technology Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Applied Technology for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Applied Technology for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Applied Technology for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Applied Technology for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Applied Technology for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Humanities and Social Science Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Humanities and Social Science for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Humanities and Social Science for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Humanities and Social Science for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Humanities and Social Science for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Humanities and Social Science for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Business, Computer Science, and Mathematics Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Business, Computer Science, and Mathematics for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Business, Computer Science, and Mathematics for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Business, Computer Science, and Mathematics for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Business, Computer Science, and Mathematics for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Business, Computer Science, and Mathematics for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Nursing Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Nursing for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Nursing for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Nursing for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Nursing for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Nursing for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Life and Physical Science Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Life and Physical Science for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Life and Physical Science for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Life and Physical Science for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Life and Physical Science for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Life and Physical Science for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("SICCM Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("SICCM for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("SICCM for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("SICCM for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("SICCM for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("SICCM for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Workforce Development Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Workforce Development for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Workforce Development for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Workforce Development for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Workforce Development for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Workforce Development for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
print(kable(over, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Independent Study Class Totals on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F1, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Independent Study for F1 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F2, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Independent Study for F2 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F4, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Independent Study for F4 Class on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F6, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Independent Study for F6 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
print(kable(F7, "latex", booktabs = TRUE, longtable = TRUE, caption = paste("Independent Study for F7 on", todays.date, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header")))
...
write.xlsx(list_of_datasets, file=paste0("G:\\Institutional Research\\From James\\enrollment pull\\daily reports\\fall daily report ", format(Sys.Date(), "%m-%d"), ".xlsx"))
#Local Storage remove to write local
write.xlsx(list_of_datasets, file=paste0("fall daily report ", format(Sys.Date(), "%m-%d"), ".xlsx"))
```
